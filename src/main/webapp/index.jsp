...
<div class="container">
    <div class="p-5 mb-4">
        ...
        <p class="fs-4">Este es el proyecto CRUD (Create, Read, Update, Delete) del alumno <span class="text-warning">Esteban Bechelli</span> para el programa "Codo a Codo"</p>
