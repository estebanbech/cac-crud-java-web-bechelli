...
package com.ebechelli.controlador;

import com.ebechelli.modelo.Alumno;
import com.ebechelli.modelo.Modelo;
import com.ebechelli.modelo.ModeloHC;
import com.ebechelli.modelo.ModeloMySQL;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (laAccion) {
            ...
            case "edit":
                ...
                break;
            case "show":
                Alumno alumno = model.getAlumno(id);
                req.setAttribute("alumnoShow", alumno);
                req.setAttribute("yaTieneFoto", !alumno.getFoto().contains("no-face"));
